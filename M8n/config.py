...
BOT_TOKEN = getenv("BOT_TOKEN", "6303627499:AAH2hgt5wkcwuAPnN5lkrNbXmoTRiPbNl4M")
BOT_NAME = getenv("BOT_NAME", "bot")
BOT_USERNAME = getenv("BOT_USERNAME", "astathonbot")
...
UPDATE = getenv("UPDATE", "astathon")
SUPPORT = getenv("SUPPORT", "astathon")
